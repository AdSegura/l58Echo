...
<div id="frame">
	...
	<div class="content">
		...
		<div class="messages">
			<ul>
                <li v-for="message in messages"  :class="sentOrReplay(message.user)">
...
<script>
    export default {
        ...
        methods: {
            send: function(e){
                e.preventDefault();
                this.messages.push({msg: this.message, user: "Me"});
                window.axios.post('/chat/1', {message: this.message})
                this.message = '';
            },
            sentOrReplay: function(user) {
                if(user === "Me") return "sent"
                return "replies"
            }
        }
    }
